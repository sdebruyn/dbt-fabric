{# Override: default__get_profile uses INFORMATION_SCHEMA.COLUMNS to get data types,
   which does not exist in Spark SQL. This override uses DESCRIBE TABLE EXTENDED instead,
   following the same pattern as dbt-profiler's databricks__get_profile. #}
